...
namespace CHKS.Application.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(string userName, string password, string redirectUrl)
        {
            try
            {
                ...
                {
                    // Create a proper admin user for development
                    ...
                    Console.WriteLine("Development mode: auto-logged in as admin.");
            ...
            catch (Exception exception)
            {
                ...
                return RedirectWithError("An error occurred while logging in", redirectUrl);
            }
